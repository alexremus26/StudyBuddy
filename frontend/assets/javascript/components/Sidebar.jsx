            ...
            {isLoggedIn ? (
              <>
                <div className="flex items-center justify-between gap-1 flex-wrap">
                  ...
                  {profile?.streak > 0 && (
                    <div className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-amber-500/10 text-amber-600 border border-amber-500/20 text-[10px] font-bold animate-pulse dark:text-amber-500" title={`${profile.streak} days streak!`}>
